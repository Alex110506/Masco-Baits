        ...
        <div className="hero-section">
            ...
            <div className="mobile-hero-sect">
                <div className="mob-sect1">
                    <img id="logo-img" src="../assets/images/logo/maco-baits-logo.png.jpg"></img>
                    <div className="mob-sect1-slide" ref={sect3Ref}>
                        <img className="active3" src="..\assets\images\mainpage\WhatsApp Image 2025-03-31 at 14.32.14_2652d762.jpg" alt="landscape image"/>
                        <img src="..\assets\images\mainpage\WhatsApp Image 2025-03-31 at 14.32.14_7085cd72.jpg" alt="landscape image"/>
                        <img src="..\assets\images\mainpage\WhatsApp Image 2025-03-31 at 14.32.15_82bc644e.jpg" alt="landscape image"/>
                    </div>
                    
                </div>
                <div className="mob-sect2" ref={sect4Ref}>
                    <img className="active4" src="..\assets\images\mainpage\WhatsApp Image 2025-03-31 at 21.58.51_2c5e7579.jpg" alt="team image"/>
                    <img src="..\assets\images\mainpage\Screenshot 2025-06-24 124541.jpg" alt="team image"/>
                    <img src="..\assets\images\mainpage\WhatsApp Image 2025-03-31 at 21.58.51_16ed0842.jpg" alt="team image"/>
                    <img src="..\assets\images\mainpage\WhatsApp Image 2025-03-31 at 21.58.51_970efb4b.jpg" alt="team image"/>
                    <img src="..\assets\images\mainpage\WhatsApp Image 2025-03-31 at 21.58.51_4093fe3e.jpg" alt="team image"/>
                    <img src="..\assets\images\mainpage\WhatsApp Image 2025-03-31 at 21.58.51_ee6ae59a.jpg" alt="team image"/>
                </div>
            </div>
