            ...
            <div className="aux-div-foot">
                ...
                <div>
                    ...
                    <p className="social-link-foot">
                        <a href="https://www.facebook.com/mascobaits/?locale=ro_RO" style={{marginTop:"0"}}><i className="bi bi-facebook" style={{fontSize:"28px"}}></i></a><br />
                        <a href="https://www.tiktok.com/@marius.mascovits" style={{marginTop:"0"}}><i className="bi bi-tiktok" style={{fontSize:"28px"}}></i></a>
                    </p>
                </div>
            </div>
